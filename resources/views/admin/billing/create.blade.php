...
@section('page-description', 'Create a new client invoice')
...
<div class="content-header billing-hero">
    <div class="header-title">
        ...
        <p>Generate a new invoice for a client visit</p>
    </div>
    ...
    <div class="billing-form-card">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select name="pet_owner_id" id="pet_owner_id" class="form-select" required>
                    ...
                    @foreach($petOwners as $owner)
                        <option value="{{ $owner->id }}" {{ old('pet_owner_id') == $owner->id ? 'selected' : '' }}>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="date" class="form-control" id="invoice_date" name="invoice_date" value="{{ old('invoice_date', now()->toDateString()) }}" required>
                @error('invoice_date')<div class="text-danger small">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4 mb-3">
                <label for="due_date" class="form-label">Due Date</label>
                <input type="date" class="form-control" id="due_date" name="due_date" value="{{ old('due_date', now()->addDays(7)->toDateString()) }}" required>
            ...
            <div class="col-md-2 mb-3">
                ...
                <input type="number" class="form-control" id="discount_amount" name="discount_amount" value="{{ old('discount_amount', 0) }}" min="0" step="0.01">
            </div>
        </div>
        <div class="mb-3">
            ...
            <table class="table items-table">
                ...
                <tbody id="items-body">
                    <tr>
                        ...
                        <td><input type="number" name="items[0][unit_price]" class="form-control" min="0" step="0.01" value="0" required></td>
