...
<div class="create-container">
    ...
    <div class="page-header">
        <h1>
            <i class="fas fa-plus-circle"></i> Create New Boarding
        </h1>
        <p>Add a new pet boarding record to the system</p>
    </div>
        ...
        <form method="POST" action="{{ route('admin.boarding.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <select name="pet_id" id="pet_id" required class="@error('pet_id') is-invalid @enderror">
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="medication_notes" id="medication_notes" 
                              ...
                              class="@error('medication_notes') is-invalid @enderror">{{ old('medication_notes') }}</textarea>
            ...
            <div class="form-section">
                ...
                <div class="form-group">
                    ...
                    <textarea name="feeding_notes" id="feeding_notes" 
                              ...
                              style="min-height: 100px;">{{ old('feeding_notes') }}</textarea>
                    @error('feeding_notes')
                        <span class="form-hint" style="color: #dc3545;">{{ $message }}</span>
                    @enderror
            ...
            <div class="form-actions">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> Create Boarding
                </button>
            </div>
        </form>
    </div>
