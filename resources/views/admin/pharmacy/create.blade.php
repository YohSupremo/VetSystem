...
@section('page-title', 'Add Pharmacy Item')
@section('page-description', 'Create a new pharmacy item')
...
<div class="content-header inventory-page-hero">
    <div class="header-title">
        <h1><i class="fas fa-plus"></i> Add Pharmacy Item</h1>
        <p>Create a new item in the pharmacy system</p>
    </div>
     ...
     <div class="form-section image-upload-section">
        <div class="form-section-header">
            <div>
                ...
                <p class="section-subtitle">Upload an image for the item.</p>
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="form-section">
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">
                <i class="fas fa-save"></i> Create Pharmacy Item
            </button>
        </div>
    </div>
</form>
