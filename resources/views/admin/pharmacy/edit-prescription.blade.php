    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1><i class="fas fa-prescription-bottle"></i> Edit Prescription</h1>
                    <p class="text-muted">Edit prescription details</p>
                </div>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.pharmacy.prescriptions.update', $prescription->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="medication" id="medication" class="form-control @error('medication') is-invalid @enderror"
                                   value="{{ old('medication', $prescription->medication) }}" required autocomplete="off">
                            @error('medication')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="dosage" id="dosage" class="form-control @error('dosage') is-invalid @enderror"
                                           value="{{ old('dosage', $prescription->dosage) }}" placeholder="e.g., 5mg, 10ml" required>
                                    @error('dosage')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="frequency" id="frequency" class="form-control @error('frequency') is-invalid @enderror"
                                           value="{{ old('frequency', $prescription->frequency) }}" placeholder="e.g., Twice daily, Every 8 hours" required>
                                    @error('frequency')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="instructions" id="instructions" class="form-control @error('instructions') is-invalid @enderror"
                                      rows="3" placeholder="Special instructions for the prescription...">{{ old('instructions', $prescription->instructions) }}</textarea>
                            @error('instructions')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ route('admin.pharmacy.prescriptions.show', $prescription->id) }}" class="btn btn-secondary">
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h6 class="mb-0"><i class="fas fa-info-circle"></i> Prescription Info</h6>
                </div>
                <div class="card-body">
                    <p class="mb-1"><strong>Created:</strong> {{ $prescription->created_at->format('M j, Y \a\t g:i A') }}</p>
                    <p class="mb-1"><strong>Last Updated:</strong> {{ $prescription->updated_at->format('M j, Y \a\t g:i A') }}</p>
                    <p class="mb-0">
