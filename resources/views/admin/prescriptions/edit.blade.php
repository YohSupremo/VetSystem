                ...
                <div class="form-group">
                    ...
                    <div class="form-control-static">
                        @if($prescription->assignedStaff)
                            <strong>{{ $prescription->assignedStaff->first_name }} {{ $prescription->assignedStaff->last_name }}</strong>
                        @else
                            <strong>Not assigned</strong>
                        @endif
                        <small class="text-muted d-block">This value is locked to the creator account and cannot be changed.</small>
                    </div>
                </div>
                ...
                @if(in_array(auth()->user()?->role, ['veterinarian', 'admin'], true))
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="external_clinic_name" class="form-control @error('external_clinic_name') is-invalid @enderror"
                                   value="{{ old('external_clinic_name', $prescription->external_clinic_name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="external_veterinarian_name" class="form-control @error('external_veterinarian_name') is-invalid @enderror"
                                   value="{{ old('external_veterinarian_name', $prescription->external_veterinarian_name) }}"
