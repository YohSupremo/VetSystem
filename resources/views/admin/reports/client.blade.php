...
<div class="content-header report-hero">
    ...
    <div class="header-actions">
        ...
        <a href="{{ route('admin.reports.export', ['reportType' => 'client', 'format' => 'pdf']) }}" class="btn btn-outline-danger">
            <i class="fas fa-file-pdf"></i> Export PDF
        </a>
        <a href="{{ route('admin.reports.export', ['reportType' => 'client']) }}" class="btn btn-outline-primary">
