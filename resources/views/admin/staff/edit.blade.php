...
@section('page-description', 'Update staff member information')
...
<div class="staff-form-wrapper">
    ...
    <div class="content-header">
        <div class="header-content">
            ...
            <div class="header-text">
                ...
                <p>Update staff information for {{ $staff->first_name ?? '' }} {{ $staff->last_name ?? '' }}</p>
            </div>
        </div>
    ...
    <!-- Enhanced Form Card -->
    <div class="form-card">
        <form method="POST" action="{{ route('admin.staff.update', ['id' => $staff->id]) }}">
            @csrf
            @method('PUT')
                ...
                <div class="status-section">
                    <div class="status-card">
                        ...
                        <div class="status-content">
                            ...
                            <p>Control whether this account can access the system</p>
                        </div>
            ...
            <div class="info-banner">
                ...
                <div class="info-content">
                    ...
                    @if(isset($staff->updated_at))
                        {{ $staff->updated_at->format('F j, Y \a\t g:i A') }}
                    @else
                        Not available
                    @endif
                </div>
