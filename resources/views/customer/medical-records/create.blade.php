...
@section('title', 'Add Medical Record - PawCare')
...
<div class="customer-container">
    ...
    <main class="customer-main">
        <form action="{{ route('customer.medical-records.store') }}" method="POST">
            @csrf
            <div class="medical-form">
                <div class="form-header">
                    <h2 class="form-title">Add Medical Record</h2>
                    <p class="form-subtitle">Record health information for your pet</p>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="date" name="visit_date" id="visit_date" required max="{{ now()->toDateString() }}">
                        </div>
                        <div class="form-group">
                            ...
                            <select name="veterinarian_id" id="veterinarian_id">
                                ...
                                <option value="{{ $vet->id }}">Dr. {{ $vet->first_name }} {{ $vet->last_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="complaint" id="complaint" placeholder="Describe the main reason for visit..."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="examination_notes">Examination Notes</label>
                        <textarea name="examination_notes" id="examination_notes" placeholder="Detailed examination findings..."></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="vital-signs">
                        <div class="form-group vital-input">
                            ...
                            <input type="number" name="temperature" id="temperature" step="0.1" placeholder="101.5">
                        </div>
                        <div class="form-group vital-input">
                            <label for="heart_rate">Heart Rate (bpm)</label>
                            <input type="number" name="heart_rate" id="heart_rate" placeholder="80">
                        </div>
                        <div class="form-group vital-input">
                            <label for="respiratory_rate">Respiratory Rate (bpm)</label>
                            <input type="number" name="respiratory_rate" id="respiratory_rate" placeholder="20">
                        </div>
                        <div class="form-group vital-input">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="diagnosis" id="diagnosis" placeholder="Final diagnosis..."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="treatment_plan">Treatment Plan</label>
                        <textarea name="treatment_plan" id="treatment_plan" placeholder="Recommended treatment..."></textarea>
                    </div>
                    <div class="form-group">
                        <label for="follow_up_date">Follow-up Date</label>
                        <input type="date" name="follow_up_date" id="follow_up_date" min="{{ now()->toDateString() }}">
                    </div>
                </div>

                <!-- Action Buttons -->
                <div class="action-buttons">
                    <a href="{{ route('customer.medical-records.index') }}" class="btn btn-secondary">
