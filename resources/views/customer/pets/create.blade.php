            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom-0 pt-4 px-4">
                    <div class="d-flex align-items-center">
                        <a href="{{ route('customer.pets.index') }}" class="text-decoration-none text-muted me-3">
                            <i class="fas fa-arrow-left"></i>
                        </a>
                        <h1 class="h3 mb-0">Register New Pet</h1>
                    </div>
                </div>
                    ...
                    <form action="{{ route('customer.pets.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 text-center mb-3">
                                <div class="mb-2">
                                    <img id="photo-preview" src="{{ asset('assets/img/default-pet.png') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="breed" id="breed" value="{{ old('breed') }}" placeholder="e.g. Labrador">
                            </div>

                            <div class="col-md-6">
                                <label for="dob" class="form-label fw-bold">Date of Birth</label>
                                <input type="date" class="form-control" name="dob" id="dob" value="{{ old('dob') }}" max="{{ date('Y-m-d') }}">
                            </div>
                            ...
                            <div class="col-12">
                                <label for="medical_history" class="form-label fw-bold">Previous Medical History</label>
                                <textarea name="medical_history" id="medical_history" class="form-control" rows="3">{{ old('medical_history') }}</textarea>
                            </div>
                        </div>
