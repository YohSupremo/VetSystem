        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                <div class="nav-section">
                   ...
                   <a href="" class="nav-item <?php echo e(request()->routeIs('admin.appointments.*') ? 'active' : ''); ?>"> 
                    ...
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.pets.*') ? 'active' : ''); ?>">
                        <i class="fas fa-paw"></i>
                        <span>Pets Registry</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.owners.*') ? 'active' : ''); ?>">
                        <i class="fas fa-users"></i>
                        <span>Pet Owners</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.queue.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.medical-records.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-medical"></i>
                        <span>Medical Records</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.vaccinations.*') ? 'active' : ''); ?>">
                        <i class="fas fa-syringe"></i>
                        <span>Vaccinations</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.prescriptions.*') ? 'active' : ''); ?>">
                        <i class="fas fa-prescription"></i>
                        <span>Prescriptions</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.surgeries.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.boarding.*') ? 'active' : ''); ?>">
                        <i class="fas fa-hotel"></i>
                        <span>Boarding</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.grooming.*') ? 'active' : ''); ?>">
                        <i class="fas fa-cut"></i>
                        <span>Grooming</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.pharmacy.*') ? 'active' : ''); ?>">
                        <i class="fas fa-capsules"></i>
                        <span>Pharmacy</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.laboratory.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.inventory.*') ? 'active' : ''); ?>">
                        <i class="fas fa-boxes"></i>
                        <span>Inventory</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.billing.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-invoice-dollar"></i>
                        <span>Billing</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.staff.*') ? 'active' : ''); ?>">
                        <i class="fas fa-user-md"></i>
                        <span>Staff</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.reports.*') ? 'active' : ''); ?>">
                        <i class="fas fa-chart-bar"></i>
                        <span>Reports</span>
                    </a>
                    <a href="" class="nav-item <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>">
