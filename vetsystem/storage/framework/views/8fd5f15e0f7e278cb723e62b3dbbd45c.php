        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="nav-menu">
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.appointments.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.appointments.*') ? 'active' : ''); ?>">
                        <i class="fas fa-calendar-check"></i>
                        <span>Appointments</span>
                        <?php if(isset($pendingAppointments) && $pendingAppointments > 0): ?>
                            <span class="badge"><?php echo e($pendingAppointments); ?></span>
                        <?php endif; ?>
                    </a>
                    <a href="<?php echo e(route('admin.pets.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.pets.*') ? 'active' : ''); ?>">
                        <i class="fas fa-paw"></i>
                        <span>Pets Registry</span>
                    </a>
                    <a href="<?php echo e(route('admin.owners.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.owners.*') ? 'active' : ''); ?>">
                        <i class="fas fa-users"></i>
                        <span>Pet Owners</span>
                    </a>
                    <a href="<?php echo e(route('admin.queue.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.queue.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.medical-records.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.medical-records.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-medical"></i>
                        <span>Medical Records</span>
                    </a>
                    <a href="<?php echo e(route('admin.vaccinations.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.vaccinations.*') ? 'active' : ''); ?>">
                        <i class="fas fa-syringe"></i>
                        <span>Vaccinations</span>
                    </a>
                    <a href="<?php echo e(route('admin.prescriptions.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.prescriptions.*') ? 'active' : ''); ?>">
                        <i class="fas fa-prescription"></i>
                        <span>Prescriptions</span>
                    </a>
                    <a href="<?php echo e(route('admin.surgeries.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.surgeries.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.boarding.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.boarding.*') ? 'active' : ''); ?>">
                        <i class="fas fa-hotel"></i>
                        <span>Boarding</span>
                    </a>
                    <a href="<?php echo e(route('admin.grooming.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.grooming.*') ? 'active' : ''); ?>">
                        <i class="fas fa-cut"></i>
                        <span>Grooming</span>
                    </a>
                    <a href="<?php echo e(route('admin.pharmacy.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.pharmacy.*') ? 'active' : ''); ?>">
                        <i class="fas fa-capsules"></i>
                        <span>Pharmacy</span>
                    </a>
                    <a href="<?php echo e(route('admin.laboratory.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.laboratory.*') ? 'active' : ''); ?>">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.billing.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.billing.*') ? 'active' : ''); ?>">
                        <i class="fas fa-file-invoice-dollar"></i>
                        <span>Billing</span>
                    </a>
                    <a href="<?php echo e(route('admin.staff.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.staff.*') ? 'active' : ''); ?>">
        ...
        <main class="main-content">
            ...
            <header class="header">
                <div class="header-left">
                    ...
                    <p><?php echo $__env->yieldContent('page-description', "Here's what's happening with your clinic today"); ?></p>
                </div>
...
</body><?php /**PATH C:\fullstack\htdocs\VetSys\vetsystem\resources\views\admin\dashboard.blade.php ENDPATH**/ ?>